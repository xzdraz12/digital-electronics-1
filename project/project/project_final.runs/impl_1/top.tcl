...
namespace eval ::optrace {
  variable script "F:/projektde1/project_final/project_final.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet F:/projektde1/project_final/project_final.runs/synth_1/top.dcp
